...
class HexPlane_Slim(HexPlane_Base):
    ...
    def __init__(self, aabb, gridSize, device, time_grid, near_far, total_image, video_split_index, **kargs):
        super().__init__(aabb, gridSize, device, time_grid, near_far, total_image, video_split_index, **kargs)
        assert (
    ...
    def get_optparam_groups(self, cfg, lr_scale=1.0):
        grad_vars = [
            {
                "params": self.pose_affine.parameters(),
                "lr": lr_scale * cfg.lr_pose_affine,
                "lr_org": cfg.lr_pose_affine
            },
            {
                "params": self.time_embedding.parameters(),
                "lr": lr_scale * cfg.lr_time_embedding,
                "lr_org": cfg.lr_time_embedding,
            },
            {
                "params": self.time_affine.parameters(),
                "lr": lr_scale * cfg.lr_time_affine,
                "lr_org": cfg.lr_time_affine,
            },
            {
            ...
            {
                "params": self.exposure_embedding.parameters(),
                "lr": lr_scale * cfg.lr_exposure_embedding,
                "lr_org": cfg.lr_exposure_embedding,
            },
            {
                "params": self.exposure_linear.parameters(),
                "lr": lr_scale * cfg.lr_exposure_linear,
                "lr_org": cfg.lr_exposure_linear
            },
            {
                "params": self.tonemapper.parameters(),
                "lr": lr_scale * cfg.lr_tonemapper,
                "lr_org": cfg.lr_tonemapper
            }
